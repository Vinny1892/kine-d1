...
| SPIKE-3 | Representação de BLOB sobre JSON | ✅ [concluído](results/spike-3.md) — hex+unhex ([ADR-0001](../adr-0001-blob-representation.md)) |
...
| SPIKE-6 | `batch` atômico e o padrão CAS | ✅ [concluído](results/spike-6.md) — viável ([ADR-0002](../adr-0002-deferred-transaction.md)) |
