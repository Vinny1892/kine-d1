...
Mede as queries reais de `pkg/drivers/generic/generic.go` (com `hex()`/`unhex()` do [ADR-0001](../../adr-0001-blob-representation.md)) contra um D1 com 300 chaves e objetos de 6 KB — tamanho típico de objeto k8s.
